...
@Component({
  selector: 'app-checking-staff',
  templateUrl: './checking-staff.component.html',
  styleUrls: ['./checking-staff.component.less']
})
export class CheckingStaffComponent implements OnInit {
