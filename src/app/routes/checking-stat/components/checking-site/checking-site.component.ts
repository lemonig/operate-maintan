...
@Component({
  selector: 'app-checking-site',
  templateUrl: './checking-site.component.html',
  styleUrls: ['./checking-site.component.less']
})
export class CheckingSiteComponent implements OnInit {
  tableData: any[] = [];
  loading = false;
  q: any = {
    pageIndex: 1,
