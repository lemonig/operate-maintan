...
@Component({
  selector: 'app-checking-province',
  templateUrl: './checking-province.component.html',
  styleUrls: ['./checking-province.component.less']
})
export class CheckingProvinceComponent implements OnInit {
  ...
  goAbnormalAllPage(status) {
    ...
    this.router.navigate(['checking'], extraDataObj)
  }
}
