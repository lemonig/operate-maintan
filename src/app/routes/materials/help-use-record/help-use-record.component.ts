...
@Component({
  selector: 'app-help-use-record',
  templateUrl: './help-use-record.component.html',
  styleUrls: ['./help-use-record.component.less']
})
export class HelpUseRecordComponent implements OnInit {
  constructor(
