...
@Component({
  selector: 'app-abnormal-contract',
  templateUrl: './abnormal-contract.component.html',
  styleUrls: ['./abnormal-contract.component.less']
})
export class AbnormalContractComponent implements OnInit {
  ...
  getTableData() {
    ...
    this.loading = true;
    this._http.post('/api/task/stat/contract', params).subscribe((res: any) => {
      this.loading = false;
      if (res.success) {
