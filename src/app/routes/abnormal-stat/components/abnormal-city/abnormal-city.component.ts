...
@Component({
  selector: 'app-abnormal-city',
  templateUrl: './abnormal-city.component.html',
  styleUrls: ['./abnormal-city.component.less']
})
export class AbnormalCityComponent implements OnInit {
  ...
  getTableData() {
    ...
    this.loading = true;
    this._http.post('/api/task/stat/region', params).subscribe((res: any) => {
      this.loading = false;
      if (res.success) {
