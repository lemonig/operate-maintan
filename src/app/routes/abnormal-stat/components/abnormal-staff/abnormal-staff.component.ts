...
@Component({
  selector: 'app-abnormal-staff',
  templateUrl: './abnormal-staff.component.html',
  styleUrls: ['./abnormal-staff.component.less']
})
export class AbnormalStaffComponent implements OnInit {
  ...
  getTableData() {
    ...
    this.loading = true;
    this._http.post('/api/task/stat/user', params).subscribe((res: any) => {
      this.loading = false;
      if (res.success) {
